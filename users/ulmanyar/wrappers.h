...
#define __________________ADJUST_L1________________     _______, _______, _______, _______, _______
#define __________________ADJUST_L2________________     _______, _______, _______, _______, _______
#define __________________ADJUST_L3________________     _______, _______, _______, _______, _______

#ifdef RGBLIGHT_ENABLE
#define __________________ADJUST_R1________________     RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI
#define __________________ADJUST_R2________________     RGB_RMOD,RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD
#define __________________ADJUST_R3________________     RGB_TOG, _______, _______, _______, _______
#else
#define __________________ADJUST_R1________________     _______, _______, _______, _______, _______
#define __________________ADJUST_R2________________     _______, _______, _______, _______, _______
#define __________________ADJUST_R3________________     _______, _______, _______, _______, _______
#endif
